...
export default function ProfileScreen(props: any) {
  ...
  return ( 
    <SafeAreaView >
      ...
      <ScrollView>
        {user && <>
        <Profile initials={initials} fullName={fullName} user={user} isMe={false} skillId={skillId} navigation={props.navigation} />
        <ProfileLink firstName={user.firstName + "'s"} navigation={props.navigation} title={'reviews'} icon={'star-outline'}/>
      </>}
    </ScrollView>
  </SafeAreaView>
  );
